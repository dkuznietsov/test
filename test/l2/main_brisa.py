...
from test.l2.src.running.brisa import BrisaTest
from test.l2.logic.stage_args import BrisaLogicArgs
...
if IS_TEST:
    START_TIME = "2025-01-14 21:00:00"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "test": KpiInfo("None", ['S13','X13','Z0D','Z0H','Z0M','Z0W','Z1E','Z1F','Z1L','Z22','Z31','Z40','Z45','Z94','ZF2','ZK7','ZKC'], logic_args)
        }
