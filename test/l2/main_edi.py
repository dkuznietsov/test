...
from test.l2.src.running.edi import EdiTest
from test.l2.logic.stage_args import EdiLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "test": KpiInfo("None", ['F20','G23','G25','G30','V05','Z0S','Z19','Z1D','Z1F','Z1L','Z1S','Z1T','Z83','ZB1'], logic_args)
        }
