...
from test.l2.src.running.edi_beol import EdiBeolTest
from test.l2.logic.stage_args import EdiBeolLogicArgs
...
if IS_TEST:
    ...
    END_TIME = n.END_TIME
    JOB_NAME = n.JOB_NAME
    RUN_FAB_LIST = n.EDI_BEOL_RUN_FAB
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "test": KpiInfo("None", ['F20','Z0S'], logic_args)
        }
        ...
        Info = TableInfo(
            ...
            delete_clause=f"DELETE FROM {db_schema}.{TEST_TABLENAME} WHERE FAB_CODE = '{FAB_CODE}' AND PROCESS_STAGE = 'BEOL'",
            kpi_steps=Steps
        )
