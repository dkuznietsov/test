...
from test.l2.src.running.cell import CellTest
from test.l2.logic.stage_args import CellLogicArgs
...
if IS_TEST:
    START_TIME = "2024-12-03 06:00:00"
    END_TIME = "2024-12-03 09:00:00"
    PROCESS_STAGE = "CELL"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "test": KpiInfo("None", ['L3C','L3D','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L8A','L8B'], logic_args)
        }
