...
from test.l2.src.running.lcm_beol import LcmBeolTest
from test.l2.logic.stage_args import LcmBeolLogicArgs
...
if IS_TEST:
    ...
    END_TIME = n.END_TIME
    JOB_NAME = n.JOB_NAME
    RUN_FAB_LIST = n.LCM_BEOL_RUN_FAB
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "test": KpiInfo("None", ['S01', 'S02'], logic_args)
        }
