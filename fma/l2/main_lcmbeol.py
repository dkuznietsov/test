...
from fma.l2.src.running.lcmbeol import LcmBeolFma
from fma.l2.logic.stage_args import LcmBeolLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "fma": KpiInfo("None", ['S01','S02'], logic_args)
        }
    ...
    print(f"Skip this LCM BEOL run because the JOB_RUN is {JOB_RUN}.")
