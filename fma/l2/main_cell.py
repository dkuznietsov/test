...
from fma.l2.src.running.cell import CellFma
from fma.l2.logic.stage_args import CellLogicArgs
...
if IS_TEST:
    START_TIME = "2024-12-23 01:00:00"
    END_TIME = "2024-12-25 23:59:00"
    PROCESS_STAGE = "CELL"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "fma": KpiInfo("None", ['L3C','L3D','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L8A','L8B'], logic_args)
        }
