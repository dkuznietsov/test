...
#20250210 查詢地上雲FMA ODS無資料。不做開發。 程式copy尚未調整修正
...
from fma.l2.src.running.edobeol import EdibeolFma
from fma.l2.logic.stage_args import EdiBeolLogicArgs
...
if IS_TEST:
    ...
    FMA_OP = config.fma_op_dict().get(FAB)
    JOB_RUN = True
    IS_RUN = "TRUE"
else:
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    print(f"Skip this EdiBeol run because the JOB_RUN is {JOB_RUN}.")
