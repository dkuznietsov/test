...
from fma.l2.src.running.brisamodule import BrisaModuleFma
from fma.l2.logic.stage_args import BrisaModuleLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "fma": KpiInfo("None", ['S13','X13','Z0D','Z0H','Z0M','Z0W','Z1F','Z1L','Z22','Z31','Z40','Z45','Z94','ZF2','ZK7','ZKC','Z1E'], logic_args)
        }
    ...
    print(f"Skip this BrisaModule run because the JOB_RUN is {JOB_RUN}.")
