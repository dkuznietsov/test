...
workflow_path_dict = {
    "MODULE": "../app_config/qadefect_module.json",
}
        ...
        for stage in ['MODULE']:
            ...
            for fab in fab_list:
                ...
                fab_set_l2_arg = {
                    ...
                    "run_if": "ALL_SUCCESS",
                    "notebook_task": {
                    "notebook_path": "qadefect/l2/l2_set_job_args",
                    "base_parameters": {
                        "START_TIME": "",
                        "END_TIME": "",
                        "FAB": fab,
                        "JOB_NAME": f"{fab}_{stage}_F2C_H_DAX_FBK_QADEFECT",
                        "PROCESS_STAGE": stage
                    },
                    "source": "GIT"
                    },
                ...
                master = {
                        "task_key": f"{fab}_{stage.lower()}_h_dax_fbk_qadefect",
                        "depends_on": [
                        {
                            "task_key": f"{fab}_{stage.lower()}_set_l2_args"
                        }
                        ...
                        "run_if": "ALL_SUCCESS",
                        "notebook_task": {
                        "notebook_path": f"qadefect/l2/main_{stage.lower()}",
                        "base_parameters": {
                            "TASK_KEY":f"{fab}_{stage.lower()}_set_l2_args"
                        },
                        "source": "GIT"
...
env = "DEV"
job_id = 38161662583954     
job_name = "FBK_QADEFECT_MODULE_ODSToCentral"
branch = "QA"
