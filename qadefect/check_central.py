...
START_UPDATE_DTM = '2024-12-02 16:00:00'  
END_UPDATE_DTM = '2024-12-03 19:00:00'
...
FROM
( 
SELECT ROW_NUMBER() OVER(PARTITION BY FAB_CODE, PROCESS_STAGE, TFT_CHIP_ID_RRN, TEST_TIME ORDER BY UPDATE_DTM DESC) AS INDEX,*    
