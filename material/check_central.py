...
START_UPDATE_DTM = '2024-12-05 16:00:00'  
END_UPDATE_DTM = '2024-12-05 19:00:00'
...
FROM
( 
SELECT ROW_NUMBER() OVER(PARTITION BY FAB_CODE, PROCESS_STAGE, TFT_CHIP_ID_RRN, MATERIAL_TYPE ORDER BY UPDATE_DTM DESC) AS INDEX,*    
