...
from material.l2.src.running.module import Material
from material.l2.logic.stage_args import ModuleLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        steps = {
            "material": KpiInfo("None", ['K01', 'K06', 'L6K', 'L8B', 'M02', 'M11', 'S01', 'S02', 'S06', 'S11'], logic_args)
        }
