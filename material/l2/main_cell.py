...
from material.l2.src.running.cell import CellMaterial
from material.l2.logic.stage_args import CellLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "material": KpiInfo("None", ['L3C','L3D','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L8A','L8B'], logic_args)
        }
