...
from material.config import Config   # Config 放在各自的資料夾
from material.l2.config.kpi_info import TableInfo, KpiInfo
from material.l2.src.running.array import ArrayMaterial
from material.l2.logic.stage_args import ArrayLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "material": KpiInfo("None", ['L3C','L3D','L4A','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L7B','L8A','L8B'], logic_args)
        }
        ...
        material.prepare_data()
        material.delete_upsert_data()
