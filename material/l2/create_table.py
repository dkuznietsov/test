...
spark.sql(f'ALTER TABLE {db_schema}.mf_all_s_all_dw_at_feedback_h_dax_fbk_material_ods SET TBLPROPERTIES (delta.autoOptimize.optimizeWrite = true, delta.autoOptimize.autoCompact = true)')
spark.sql(f'ALTER TABLE {db_schema}.mf_all_s_all_dw_at_feedback_h_dax_fbk_material_ods CLUSTER BY (PROCESS_STAGE, FAB_CODE)') 
