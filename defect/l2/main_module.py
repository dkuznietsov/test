...
from defect.l2.src.running.module import ModuleDefect
from defect.l2.logic.stage_args import ModuleLogicArgs
...
if IS_TEST:
    START_TIME = "2025-02-24 13:30:00"
    END_TIME = "2025-02-26 21:00:00"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "defect": KpiInfo("None", ['M02', 'M11', 'S01', 'K01', 'S02', 'S11', 'S06', 'K06', 'L6K'], logic_args),
            "defect_ods": KpiInfo("None", ['L8B'], logic_args)
        }
