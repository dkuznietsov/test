...
from defect.l2.src.running.edimodule import EdiModuleDefect
from defect.l2.logic.stage_args import EdiModuleLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "defect": KpiInfo("None", ['V05','ZB1','Z83','Z1T','Z1S','Z1L','Z1F','Z1D','Z19','Z0S','G30','G25','G23','F20'], logic_args)
        }
