...
from defect.l2.src.running.lcmbeol import LcmBeolDefect
from defect.l2.logic.stage_args import LcmBeolLogicArgs
...
if IS_TEST:
    ...
    DEFECT_OP = config.defect_op_dict().get(f"{PROCESS_STAGE}_{FAB}")
    JOB_RUN = True
    IS_RUN = "TRUE"
else:
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "defect": KpiInfo("None", ['S01', 'S02'], logic_args)
        }
