...
FROM
( 
SELECT ROW_NUMBER() OVER(PARTITION BY FAB_CODE, PROCESS_STAGE, TFT_CHIP_ID_RRN, TEST_TYPE, TEST_TIME, DEFECT_CODE, TEST_SIGNAL_NO, TEST_GATE_NO ORDER BY UPDATE_DTM DESC) AS INDEX,*    
