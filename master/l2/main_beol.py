...
from master.l2.src.running.beol import BeolMaster
from master.l2.logic.stage_args import BeolLogicArgs
...
# Table Name
MASTER_TABLENAME = config.mf_all_b_cel_kpi_at_feedback_h_dax_fbk_master_ods_beol_temp

if IS_TEST:
    START_TIME = "2024-05-19 03:15:00"
    END_TIME = "2024-05-19 03:30:00"
    PROCESS_STAGE = "BEOL"
