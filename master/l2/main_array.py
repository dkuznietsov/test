...
from master.l2.src.running.array import ArrayMaster
from master.l2.logic.stage_args import ArrayLogicArgs
...
# Table Name
MASTER_TABLENAME = config.mf_all_b_ary_kpi_at_feedback_h_dax_fbk_master_ods_array_temp

if IS_TEST:
    START_TIME = "2024-10-14 06:00:00"
    END_TIME = "2024-10-18 09:00:00"
    PROCESS_STAGE = "ARRAY"
    RUN_FAB_LIST = ['L3C','L3D','L4A','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L7B','L8A','L8B']
