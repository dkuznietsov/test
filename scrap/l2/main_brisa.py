...
from scrap.l2.src.running.brisa import Scrap
from scrap.l2.logic.stage_args import BrisaLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        steps = {
            "scrap": KpiInfo("None",  ['Z40', 'Z45', 'Z31', 'Z0N'], logic_args)
        }
