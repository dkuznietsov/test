...
from qa.l2.src.running.brisamodule import BrisaModuleQa
from qa.l2.logic.stage_args import BrisaModuleLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "qa": KpiInfo("None", ['S13','X13','Z0D','Z0H','Z0M','Z0W','Z1E','Z1F','Z1L','Z22','Z31','Z40','Z45','Z94','ZF2','ZK7','ZKC'], logic_args)
        }
