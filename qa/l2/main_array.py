...
from qa.l2.src.running.array import ArrayQa
from qa.l2.logic.stage_args import ArrayLogicArgs
...
if IS_TEST:
    START_TIME = "2024-12-15 03:40:00"
    END_TIME = "2024-12-17 04:00:00"
    PROCESS_STAGE = "ARRAY"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "qa": KpiInfo("None", ['L3C','L3D','L4A','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L7B','L8A','L8B'], logic_args)
        }
