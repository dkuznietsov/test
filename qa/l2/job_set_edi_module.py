...
job_name = "FBK_QA_EDI_Module_ODSToCentral"
branch = "QA"
L2_L3 = JobMigration(deploy_env=env, which_job="EDIMODULE")
L2_L3.reset_job(stage="EDIMODULE", target_job_id=job_id, target_job_name=job_name, target_branch=branch)
