...
workflow_path_dict = {
    "BRISAMODULE": "../app_config/qa_brisamodule.json",
}
...
class JobMigration:
    ...
    def revised_job(self) -> None:
        ...
        def fab2(stage: str):
            fab_dict = {
                'BRISAMODULE': ['S13','X13','Z0D','Z0H','Z0M','Z0W','Z1E','Z1F','Z1L','Z22','Z31','Z40','Z45','Z94','ZF2','ZK7','ZKC'],
            }
            print(stage)
...
env = "DEV"
job_id = 500222020778121    
job_name = "FBK_QA_Brisa_Module_ODSToCentral"
branch = "QA"
