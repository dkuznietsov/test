...
from qa.l2.src.running.cell import CellQa
from qa.l2.logic.stage_args import CellLogicArgs
...
if IS_TEST:
    START_TIME = "2024-12-16 03:40:00"
    END_TIME = "2024-12-16 14:00:00"
    PROCESS_STAGE = "CELL"
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "qa": KpiInfo("None", ['L3C','L3D','L5B','L5C','L5D','L6A','L6B','L6K','L7A','L8A','L8B'], logic_args)
        }
