...
from qa.l2.src.running.module import ModuleQa
from qa.l2.logic.stage_args import ModuleLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "qa": KpiInfo("None", ['K01','K06','L6K','M02','M11','S01','S02','S06','S11','S17'], logic_args),
            "qa_ods": KpiInfo("None", ['L8B'], logic_args)
        }
