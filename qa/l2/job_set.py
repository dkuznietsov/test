...
workflow_path_dict = {
    "EDIBEOL": "../app_config/qa_edimodule.json",
}
...
>>>>>>> origin
            ...
            for fab in fab_list:
                ...
                fab_set_l2_arg = {
                    ...
                    "run_if": "ALL_SUCCESS",
                    "notebook_task": {
                    "notebook_path": "qa/l2/l2_set_job_args",
                    "base_parameters": {
                        "START_TIME": "",
                        "END_TIME": "",
                        "FAB": fab,
                        "JOB_NAME": f"{fab}_{stage}_F2C_H_DAX_FBK_QA",
                        "PROCESS_STAGE": stage
                    },
                    "source": "GIT"
                    },
                ...
                master = {
                        "task_key": f"{fab}_{stage.lower()}_h_dax_fbk_qa",
                        "depends_on": [
                        {
                            "task_key": f"{fab}_{stage.lower()}_set_l2_args"
                        }
                        ...
                        "run_if": "ALL_SUCCESS",
                        "notebook_task": {
                        "notebook_path": f"qa/l2/main_{stage.lower()}",
                        "base_parameters": {
                            "TASK_KEY":f"{fab}_{stage.lower()}_set_l2_args"
                        },
                        "source": "GIT"
...
env = "DEV"
<<<<<<< HEAD
job_id = 705900010554562    
job_name = "FBK_QA_EDI_Beol_ODSToCentral"
branch = "QA"
L2_L3 = JobMigration(deploy_env=env, which_job="EDIBEOL")
L2_L3.reset_job(stage="EDIBEOL", target_job_id=job_id, target_job_name=job_name, target_branch=branch)
=======
job_id = 752266059311720 
job_name = "FBK_QA_Module_ODSToCentral"
branch = "QA"
L2_L3 = JobMigration(deploy_env=env, which_job="QA_MODULE")
