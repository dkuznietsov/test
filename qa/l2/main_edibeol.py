...
from qa.l2.src.running.edibeol import EdiBeolQa
from qa.l2.logic.stage_args import EdiBeolLogicArgs
...
if (JOB_RUN and IS_RUN == "TRUE"):
    ...
    try:
        ...
        Steps = {
            "qa": KpiInfo("None", ['F20'], logic_args)
        }
